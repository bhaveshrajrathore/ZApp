...
class Overview extends Component {
  ...
  componentWillMount() {
    const { userName, updateFetchedUrlProp } = this.props;
  ...
  overViewService = (userName) => {
    ...
    OverviewStatsApi.getOverviewStats(username)
      .then(async (responseJson) => {
        await this.setState({ checkCount: (responseJson.totalAssessmentCount - responseJson.givenAssessmentCount) });
      });
  }
      ...
      <Container>
        ...
        <ScrollView scrollEnabled={false}>
          <ScrollView
            ...
            contentContainerStyle={{ height: 165, width: 1200, backgroundColor: '#f7f7f7' }}
            style={{ flexDirection: 'row' }}
          >
            <TouchableOpacity style={styles.smallCard} onPress={() => this.handleOpen('Physical')}>
        ...
        <ScrollView>
          <View style={styles.homeContainer}>
            <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('AssessmentList')}>
