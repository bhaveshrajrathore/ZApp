...
import {
  ...
  updateDob, updateUserSocialImage
...
class Form extends Component {
  ...
  loginUser = () => {
    ...
    const {
      goHome, updateName, updateUserDob, updateSocialImage, updateUserCurrenpntFlow
    } = this.props;
  ...
  checkUserByEmail = (medium) => {
    const {
      goHome, updateName, updateUserDob, updateUserCurrentFlow, uEmail
    } = this.props;
  ...
  completeRegisteration = async (userinfo) => {
    ...
    const {
      showAlert, updateUserCurrentFlow, uSocialImage, uName
    } = this.props;
    const profileImage = {
  ...
  render() {
    const {
      uPasscode, showAlert, alertMessage, isTouchIdEnabledState
    } = this.state;
